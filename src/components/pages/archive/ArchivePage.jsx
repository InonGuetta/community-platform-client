...
const ArchivePage = () => {
  const { filteredMedia, status, typeFilter, handleFilter, handleSearch, handleOpenMedia, handleOpenUpload } = useArchivePageController();
  ...
  return (
    <Box sx={{ p: 3 }}>
      ...
      <MediaGrid items={filteredMedia} status={status} onView={handleOpenMedia} />
